...
const TaskModelSchema = CollectionSchema(
  ...
  links: {
    r'device': LinkSchema(
      id: -2771096843984984731,
      name: r'device',
      target: r'DeviceModel',
      single: true,
    )
  },
  embeddedSchemas: {},
...
void _taskModelSerialize(
  ...
  writer.writeLong(offsets[0], object.intervalDays);
  writer.writeDateTime(offsets[1], object.lastCompletedAt);
...
TaskModel _taskModelDeserialize(
  ...
  object.id = id;
  object.intervalDays = reader.readLong(offsets[0]);
  object.lastCompletedAt = reader.readDateTimeOrNull(offsets[1]);
...
void _taskModelAttach(IsarCollection<dynamic> col, Id id, TaskModel object) {
  object.id = id;
  object.device.attach(col, col.isar.collection<DeviceModel>(), r'device', id);
}
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> intervalDaysEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> intervalDaysBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskModelQueryLinks
    on QueryBuilder<TaskModel, TaskModel, QFilterCondition> {
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> device(
      FilterQuery<DeviceModel> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'device');
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> deviceIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByIntervalDays() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'intervalDays', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByIntervalDaysDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'intervalDays', Sort.desc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByLastCompletedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastCompletedAt', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByLastCompletedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByIntervalDays() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'intervalDays', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByIntervalDaysDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'intervalDays', Sort.desc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByLastCompletedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastCompletedAt', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByLastCompletedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastCompletedAt', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByIntervalDays() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'intervalDays');
    });
  }

  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByLastCompletedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, int, QQueryOperations> intervalDaysProperty() {
    return QueryBuilder.apply(this, (query) {
